        ...
        if flag:
            ...
            if len(recorg_id_list) > 0:
                ...
                cursor.execute('insert into qdyy_data.JH_BUSI_INFO@szyy3 '
                               ...
                               , (int(item.id), item.group_id, item.region_id, item.busi_id, item.rule_id, org_id, str(staff_id),rec_date,item.op_time,
        ...
        if flag:
            ...
            if len(recorg_id_list) > 0:
                ...
                cursor.execute('insert into qdyy_data.JH_BUSI_INFO@szyy3'
                               ...
                               , (int(item.id), item.group_id, item.region_id, item.busi_id, item.rule_id, org_id, item.staff_id, rec_date, item.time,
        ...
        if flag:
            ...
            if len(recorg_id_list) > 0:
                ...
                cursor.execute('insert into qdyy_data.JH_BUSI_INFO@szyy3 '
                               ...
                               , (int(item.id), item.group_id, item.region_id, item.busi_id, item.rule_id, org_id, item.staff_id, rec_date,item.op_time,
